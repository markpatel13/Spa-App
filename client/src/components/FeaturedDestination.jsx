...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      ...
      <Title title='Healing touch Therapy' subTitle='Rebalance your body mind and soul,Through the timeless power of touch and tranquility'/>
